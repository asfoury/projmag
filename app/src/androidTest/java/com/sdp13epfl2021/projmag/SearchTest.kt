...
class SearchTest {
    ...
    fun searchTest() {
        ...
        searchAutoComplete.perform(replaceText("gui "), closeSoftKeyboard())
        ...
        searchAutoComplete3.perform(replaceText("gui d"), closeSoftKeyboard())
        ...
        searchAutoComplete4.perform(replaceText("rec"), closeSoftKeyboard())
    }
