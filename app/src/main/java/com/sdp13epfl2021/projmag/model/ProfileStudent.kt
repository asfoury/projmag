...
class ProfileStudent( lastName : String,  firstName : String,  age : Int,  gender : Gender, val sciper:Int, phoneNumber : String)
    ...
    companion object{
        ...
        fun build(lastName : String, firstName : String,
                  age : Int, gender : Gender, sciper : Int, phoneNumber :String) : Result<ProfileStudent> {
            return when{
                ...
                else -> Success(ProfileStudent(lastName,  firstName,
    ...
    fun buildCopy(lastName: String = this.lastName, firstName : String = this.firstName,
                  ...
                  phoneNumber :String = this.phoneNumber) : Result<ProfileStudent>{
        return ProfileStudent.build(lastName,  firstName,
            age,  gender,  sciper,  phoneNumber)
